...
def main():
    ...
    t = 9400000
    max_val = 940000
    repeticoes = 73 #Usa o número máximo de amostras obtidos anteriormente

    with open("notebook-pessoal/questao-1/resultados/resultado_questao_b.csv", "w", newline="") as arquivo_csv:
